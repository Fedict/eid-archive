...
Name: eidlink-archive-fedora
Version: 2020
Release: 1
License: MIT

Source0: eidlink-archive-fedora.repo
...
%{__install} -Dp -m0644 %{SOURCE0} %{buildroot}%{_sysconfdir}/yum.repos.d/eidlink-archive.repo
...
%config(noreplace) /etc/yum.repos.d/eidlink-archive.repo
